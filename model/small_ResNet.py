...
class m_ResNet(nn.Module):
    def __init__(self,block,num_classes,num_blocks,*args,**kwargs):
        ...
        if kwargs.get('classifier'):
            self.fc = kwargs['classifirt'](512*block.expandFactor,num_classes)
