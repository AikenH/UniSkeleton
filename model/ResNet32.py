...
@github: https://github.com/zhangyongshun/BagofTricks-LT
@Paper: 
it's Reference:
...
def res32_cifar(cfg=None, pretrain=True, pretrained_model="", last_layer_stride=2,):
...
if __name__ == "__main__":
    ...
    # summary(modela.cuda(),input_size = (3,32,32), batch_size=1)
