"""
@AikenHong 2021
Design the SimClR Loss With Memory Bank(MoCo) to Increase the Batchsize
SimCLR:
MoCo:
Lightly:
"""
...
# !! find out why the process will goes weird when we enable memory bank
class MemoryBankModule(torch.nn.Module):
    ...
    def forward(self,
        ...
        Args:
            ...
            update:
                Using require_grad to set up this params.
        Returns:
